declare module 'sweetalert2' {
    ...
    namespace Swal {
        ...
        /**
         * Shows a verify message.
         *
         * @param validationMessage The verify message.
         */
        function showValidationMessage(validationMessage: string): void;

        /**
         * Hides verify message.
         */
        ...
        /**
         * Gets the verify message container.
         */
    ...
    export interface SweetAlertOptions {
        ...
        /**
         * A custom verify message for default validators (email, url).
         *
         * ex.
         *   Swal.fire({
         *     input: 'email',
