...
window.yii = (function ($) {
    var pub = {
        ...
        /**
         * @return string|undefined the CSRF parameter name. Undefined is returned if CSRF verify is not enabled.
         */
        ...
        /**
         * @return string|undefined the CSRF token. Undefined is returned if CSRF verify is not enabled.
         */
