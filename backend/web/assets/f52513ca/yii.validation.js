 ...
 * Yii verify module.
 *
 * This JavaScript module provides the verify methods for the built-in validators.
 *
...
yii.validation = (function ($) {
    var pub = {
        ...
        image: function (attribute, messages, options, deferredList) {
            ...
            $.each(files, function (i, file) {
                ...
                // Skip image verify if FileReader API is not available
    ...
    function getUploadedFiles(attribute, messages, options) {
        // Skip verify if File API is not available
        ...
        // Skip verify if file input does not exist
