                        ...
                        <div class = "card-body">
                           ...
                           <div class = "form-group">
                            ...
                            <div class = "form-group">
                                ...
                                <textarea rows="5" id = "<?php echo $counter; ?>" name = "post[post_content]" class = "ace-editor summernote"><?php echo (isset($editable['post_content'])) ? $editable['post_content'] : '' ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class = "card-body">
                           ...
                           <div class = "form-group">
                              ...
                              <select id = "<?php echo $counter; ?>" name = "post[category_id]" class = "form-control required">
                                  <?php
                                  if(isset($editable['category_id']) && $editable['category_id'] != '') {
