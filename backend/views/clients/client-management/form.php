      ...
      <div class = "row page-titles">
         <div class = "col-md-12 align-self-center">
            ...
            <div class = "page-actions ">
               <a class = "btn btn-secondary <?php echo (isset($editable['title'])) ? '' : 'd_none'; ?>" href = "<?php echo Yii::$app->request->baseUrl; ?>/clients/post/">
                  ...
                  <div class = "card-body">
                     ...
                     <div class = "form-group">
                        ...
                        <select id = "<?php echo $counter; ?>" name = "post[client_id]" class = "form-control ">
                            <?php
                            if (isset($editable['client_id']) && $editable['client_id'] != '') {
                                foreach ($clients as $c) { ?>
                                   <option <?php if ($c['id'] == $editable['client_id']) {
                                       echo 'selected';
                                   } ?>
                                ...
                                foreach ($clients as $c => $k  ) {
                                    if(!in_array($k['id'],$existing_client_id)) {?>
                     ...
                     <div class = "form-group">
                        ...
                        <input id = "<?php echo $counter; ?>" name = "post[title]" class = "summernote" value = " <?php echo (isset($editable['title'])) ? $editable['title'] : '' ?>">
                     </div>
                     <div class = "form-group">
                         <?php $counter++; ?>
               ...
               <div class = "card">
                  <div class = "card-body">
                     ...
                     <div class = "form-group">
                        ...
                        <textarea rows = "5" id = "<?php echo $counter; ?>" name = "post[content]" class = "ace-editor summernote"><?php echo (isset($editable['content'])) ? $editable['content'] : '' ?></textarea>
                     </div>
                  </div>
               </div>
