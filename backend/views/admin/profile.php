                    ...
                    <div class="widget-content text-center bg-white padding-40 user-description">
                        <div class="avatar avatar-100 margin-bottom-20">
                            <?php if (!empty($user['profile_picture'])) : ?>
                                <img src="<?php echo Yii::$app->params['image_path']['profile'] . $user['profile_picture']; ?>" alt="<?php echo $user['name']; ?>">
                            <?php else : ?>
                                <img src="<?php echo Yii::$app->params['image_path']['image'] . '../images/user-profile-pic.jpg'; ?>" alt="<?php echo $user['name']; ?>">
                            <?php endif; ?>
                        </div>
