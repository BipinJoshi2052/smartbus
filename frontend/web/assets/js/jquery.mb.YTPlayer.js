...
(function (jQuery, ytp) {
    ...
    (function (c) {
        c.extend({
            metadata: {
                defaults: {type: "class", name: "metadata", cre: /({.*})/, single: "metadata"}, setType: function (b, c) {
    ...
    jQuery.mbYTPlayer = {
        ...
        defaults: {
            ...
            addRaster: false,
            opacity: 1,
            quality: "medium", //or “small”, “medium”, “large”, “hd720”, “hd1080”, “highres”
            mute: false,
            loop: true,
            showControls: true,
        ...
        controls: {
            ...
            onlyYT: '<i class = "fa fa-expand"></i>',
            showSite: '<i class = "fa fa-link"></i>',
            ytLogo: '<i class = "fa fa-youtube"></i>'
        },
        ...
        buildPlayer: function (options) {
            ...
            return this.each(function () {
                ...
                var playerBox = jQuery("<div></div>").attr("id", playerID).addClass("playerBox");
                var overlay = jQuery("<div></div>").css({position: "absolute", top: 0, left: 0, width: "100%", height: "100%"}).addClass("YTPOverlay"); //YTPlayer.isBackground ? "fixed" :
                ...
                var wrapper = jQuery("<div></div>").addClass("mbYTP_wrapper").attr("id", "wrapper_" + playerID);
        ...
        buildYTPControls: function () {
            ...
            var controlBar = jQuery("<span></span>").attr("id", "controlBar_" + YTPlayer.id).addClass("mb_YTVPBar").css({whiteSpace: "noWrap", position: YTPlayer.isBackground ? "fixed" : "absolute", zIndex: YTPlayer.isBackground ? 10000 : 1000}).hide();
            var buttonBar = jQuery("<div></div>").addClass("buttonBar");
            ...
            var idx = jQuery("<span></span>").addClass("mb_YTVPTime");

            var vURL = data.videoURL;
            if (vURL.indexOf("http") < 0)
                vURL = jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/watch?v=" + data.videoURL;
            var movieUrl = jQuery("<span></span>").html(jQuery.mbYTPlayer.controls.ytLogo).addClass("mb_YTVPUrl ytpicon").attr("title", "view on YouTube").on("click", function () {
                window.open(vURL, "viewOnYT")
            });
            var onlyVideo = jQuery("<span></span>").html(jQuery.mbYTPlayer.controls.onlyYT).addClass("mb_OnlyYT ytpicon").on("click", function () {
                jQuery(YTPlayer).fullscreen(data.realfullscreen);
            });

            var progressBar = jQuery("<div></div>").addClass("mb_YTVPProgress").css("position", "absolute").click(function (e) {
            ...
            var loadedBar = jQuery("<div></div>").addClass("mb_YTVPLoaded").css("position", "absolute");
            var timeBar = jQuery("<div></div>").addClass("mb_YTVTime").css("position", "absolute");
