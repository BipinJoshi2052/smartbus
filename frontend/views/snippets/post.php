<div class="section-title text-left animated fadeInUp visible" data-animation="fadeInUp">
   <!-- Heading -->
   <h2 class="title"><?= ucwords($type) ?> Updates</h2>
</div>
<ul class="latest-posts">
   <?php for ($i = 1; $i <= 3; $i++) : ?>
      <li data-animation="fadeInLeft" class="animated fadeInLeft visible">
         <div class="post-thumb">
            <a href="<?= Yii::$app->request->baseUrl; ?>/post/<?= $type ?>/">
   ...
   <?php endfor; ?>
   <div class="section-footer text-center p-v-30">
      <a href="<?=  Yii::$app->request->baseUrl; ?>/<?= $type ?>" class="btn btn-primary">View All</a>
   </div>
</ul>