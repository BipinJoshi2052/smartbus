                ...
                <div class = "panel-group list-style" id = "faq-accordion">
                    <div id = "mix-container" class = "portfolio-grid">
                        <div class = "panel panel-default mix all">
                            <div class = "panel-heading">
                                <div class = "panel-title">
                                    <a data-toggle = "collapse" data-parent = "#faq-accordion" href = "#collapse1">How do I become an author?</a>
                                </div>
                            </div>
                        ...
                        <div class = "panel panel-default mix panel-bg graphic-design all">
                            <div class = "panel-heading">
                                <div class = "panel-title">
                                    <a data-toggle = "collapse" data-parent = "#faq-accordion" href = "#collapse2">Helpful Resources for Authors</a>
                                </div>
                            </div>
                        ...
                        <div class = "panel panel-default mix panel-bg web-design all">
                            <div class = "panel-heading">
                                <div class = "panel-title">
                                    <a data-toggle = "collapse" data-parent = "#faq-accordion" href = "#collapse3">Can I offer my items for free on a promotional basis?</a>
                                </div>
                            </div>
                        ...
                        <div class = "panel panel-default mix panel-bg ecommerce all">
                            <div class = "panel-heading">
                                <div class = "panel-title">
                                    <a data-toggle = "collapse" data-parent = "#faq-accordion" href = "#collapse4">An Introduction to the Marketplaces for Authors</a>
                                </div>
                            </div>
                        ...
                        <div class = "panel panel-default mix panel-bg graphis-design all">
                            <div class = "panel-heading">
                                <div class = "panel-title">
                                    <a data-toggle = "collapse" data-parent = "#faq-accordion" href = "#collapse5">How does the Tuts+ Premium affiliate program work?</a>
                                </div>
                            </div>
                        ...
                        <div class = "panel panel-default mix panel-bg web-design">
                            <div class = "panel-heading">
                                <div class = "panel-title">
                                    <a data-toggle = "collapse" data-parent = "#faq-accordion" href = "#collapse6">What Images, Videos, Code or Music Can I Use in my Items?</a>
                                </div>
                            </div>
