               ...
               <div class = "tab-content tab-content-01" id = "pills-tabContent">
                  <div class = "tab-pane fade show active" id = "pills-home" role = "tabpanel" aria-labelledby = "pills-home-tab">
                     ...
                     <div class = "input-group">
                        <input class = "input-name form-control form-02" type = "text"  placeholder = "Boearding Point">
                     ...
                     <div class = "input-text form-group">
                        <input class = "input-name form-control" type = "text"  placeholder = "Droping Point">
                     </div>
                     <div class = "input-text form-group ">
