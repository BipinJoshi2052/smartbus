...
class BaseFileHelper
{
     ...
     * whose name is the same as the language code. For example, given the file "path/to/applicants.php"
     * and language code "zh-CN", the localized file will be looked for as
     * "path/to/zh-CN/applicants.php". If the file is not found, it will try a fallback with just a language code that is
     * "zh" i.e. "path/to/zh/applicants.php". If it is not found as well the original file will be returned.
     *
