...
class NepaliDate extends Component {
    ...
    private $end_ne      = "2095";
    private $end_en      = "2038";
    private $month_name  = ['ब‌ैशाख', 'जेठ', 'असार', 'साउन', 'भदौ', 'असोज', 'कार्तिक', 'मङ्सिर', 'पुस', 'माघ', 'फाल्गुण', 'चैत'];
    private $day_name    = ['अाईतबार', 'सोमबार', 'मङ्गलबार', 'बुधबार', 'बिहिबार', 'शुक्रबार', 'शनिवार'];
