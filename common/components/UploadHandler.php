...
class UploadHandler {
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = [
                ...
                // 'script_url'                       => $this->get_full_url() . '/' . $this->basename($this->get_server_var('SCRIPT_NAME')),
                'upload_dir'                       => \Yii::$app->params['upload_path']['image'],
                // 'upload_url'                       => \Yii::$app->request->baseUrl . '/common/assets/images/uploads/',
                'upload_url'                       => '',
                ...
                'max_file_size'                    => \Yii::$app->params['image_size'],
                'min_file_size'                    => 1,
    ...
    protected function get_unique_filename($file_path, $name, $size, $type, $error,
        ...
        $name = Misc::timestamp() . substr($a[0], 0, 3) . '.' . end($a);
