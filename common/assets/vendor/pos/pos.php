...
$this->registerJsFile(Yii::$app->request->baseUrl . '/common/assets/vendor/css/pos.css');
$this->registerJsFile(Yii::$app->request->baseUrl . '/common/assets/vendor/js/pos.js');

?>
<div class="container pos">
   <div class="page-titles p-t-0 p-b-0">
      <h3></h3>
      <form method="get" action="<?php echo Yii::$app->request->baseUrl; ?>/pos/">
