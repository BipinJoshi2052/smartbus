...
/**
 * This is the model class for table "vehicle_seats".
 *
 * @property int $id
 ...
 */
class VehicleSeats extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['name', 'status', 'vehicle_id', 'created_by'], 'required'],
            [['status', 'vehicle_id', 'created_by', 'updated_by'], 'integer'],
